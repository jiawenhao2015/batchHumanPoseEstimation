...
namespace BVHViewer_DataAccess
{
    ...
    BvhReader::BvhReader()
    {
        if (mKeywordValues.empty())
        {
			...
			mKeywordValues.insert(make_pair("Xscale", E_BVH_TOKEN_TKW_XSCALE));	//
			mKeywordValues.insert(make_pair("Yscale", E_BVH_TOKEN_TKW_YSCALE));	//
			mKeywordValues.insert(make_pair("Zscale", E_BVH_TOKEN_TKW_ZSCALE));	//
        ...
        if (mTokenRepresentations.empty())
        {
			...
			mTokenRepresentations.insert(make_pair(E_BVH_TOKEN_TKW_XSCALE, "Xscale"));//
			mTokenRepresentations.insert(make_pair(E_BVH_TOKEN_TKW_YSCALE, "Yscale"));//
			mTokenRepresentations.insert(make_pair(E_BVH_TOKEN_TKW_ZSCALE, "Zscale"));//
