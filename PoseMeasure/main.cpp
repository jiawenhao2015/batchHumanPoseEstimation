...
//	pm.creatClusterFeatureDianxianmian(7, 9, 1, 1, 0, 299,4);//138维
	int k = 10;
	int testindex = 71065;
//	pm.testknn(true, k, testindex, 7, 9, 1, 1, 0, 299,"W_bsm7-9dianxianmian.txt",138,1, 4);//true是聚类特征 最后一个参数是代表是几个特征点 默认3维
//	pm.testknn(false, k, testindex, 7, 9, 1, 1, 0, 299, "W_bsm7-9guanjie.txt", 60,1, 4);//true是聚类特征 最后一个参数是代表是几个特征点 默认3维
